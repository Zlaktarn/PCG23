...
public class DiamondSquareScript : MonoBehaviour
{
    ...
    void CreateTerrain()
    {
        ...
        {
            averageHeight += mVerts[i].y;
        }
        print("Average Height: " + averageHeight / mVerts.Length);
    ...
    void DiamondSquare(int row, int col, int size, float offset)
    {
        ...
        //{
        //    print(halfSize);
        //    //print(mVerts[mid - halfSize].y);
        //    //print(mVerts[mid + halfSize].y);
        //    //print(mVerts[botLeft + halfSize].y);
